...
import { getDefaultCourseAssessmentConfig } from "@/app/Courses/CourseRegistry";
...
import type { QuestionCalculatorStatus } from "@/app/Assessments/Questions/Selection/QuestionSelectionTypes";
...
type CalculatorAuditResult = {
  ...
  violations: AssessmentQualityNote[];
};
...
function buildBasisNote(audit: CalculatorAuditResult): AssessmentQualityNote {
  return {
...
function buildPassNote(audit: CalculatorAuditResult): AssessmentQualityNote {
  return {
...
function auditCalculatorSuitability(args: {
  ...
  const violations: AssessmentQualityNote[] = [];
...
}: BuildCalculatorSuitabilityNotesArgs): AssessmentQualityNote[] {
