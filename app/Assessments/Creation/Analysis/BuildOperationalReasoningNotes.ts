...
import type { Paper, Question } from "@/app/Assessments/AssessmentTypes";
...
function buildAdvisedReasoningNote(balance: ThinkingTypeBalance): AssessmentQualityNote {
  return {
...
function buildEssentialReasoningNote(balance: ThinkingTypeBalance): AssessmentQualityNote {
  return {
...
}: BuildOperationalReasoningNotesArgs): AssessmentQualityNote[] {
