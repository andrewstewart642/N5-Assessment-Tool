...
/*
 * Retained for compatibility with code paths
 * that genuinely want a mark-derived duration.
 *
 * The Assessment Creator's automatic sitting
 * time no longer uses this function directly.
 */
export function calculateAssessmentPaperEndTime({
  ...
  return calculateAssessmentPaperEndTimeFromDuration({
    startTime,
