// app/Courses/National5Maths/Skills/National5MathsSkills.ts
...
type ConceptBuildOptions = {
  paperSuitability?: NonNullable<
    Concept["metadata"]
  >["paperSuitability"];

  calculator?: NonNullable<
    Concept["metadata"]
  >["calculator"];
};
...
export const skillsData: SkillsData = {
  "Numerical Skills": [
     ...
     * N4.1
     *
     * Reverse percentage is retained as a
     * both-papers skill.
     *
     * Historical source evidence contains both
     * non-calculator and calculator variants, so
     * calculator use remains optional at the
     * Skills Tree level.
     */
    buildSkill(
     ...
     *
     * All confirmed historical examples in the
     * hardened source catalogue are calculator
     * paper questions.
     *
     * N4.2 is the mixed selector.
     *
     * N4.2.1 and N4.2.2 are thin direction
     * selectors over the same underlying
     * compound-percentage generator.
     */
    buildSkill(
    ...
    buildSkill(
      ...
      [
        buildConcept(
          "alg-a6-3",
          "A6.3",
          "Gradient / intercept from equation",
          2,
          "C"
        ),
      ],
    ...
    buildSkill(
      ...
      [
        buildConcept(
          "alg-a13-4",
          "A13.4",
          "Solve quadratics using formula",
          3,
          "C+A"
        ),
      ],
    ...
    buildSkill(
      ...
      [
        buildConcept(
          "geo-g4-2",
          "G4.2",
          "Pythagoras in circle chord context",
          3,
          "C+A"
        ),
      ],
    ...
    buildSkill(
      ...
      [
        buildConcept(
          "stat-s1-1",
          "S1.1",
          "Median & semi-interquartile range comparison",
          3,
          "C+A"
        ),
      ],
