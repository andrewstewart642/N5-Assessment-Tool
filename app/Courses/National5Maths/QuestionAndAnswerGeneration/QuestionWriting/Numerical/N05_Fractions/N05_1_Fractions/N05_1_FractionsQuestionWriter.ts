...
} from "@/app/Courses/National5Maths/ExamQuestionAndAnswerCatalog/Questions/National5MathsExamQuestionCatalog";
...
function countExamQuestionsForFamily(
  familyId:
    FractionFamilyId
): number {
  return (
