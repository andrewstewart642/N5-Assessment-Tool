...
const evidence = qpEvidence("11", 29, "QUESTION", "P2", 13);

export const N5_MATHS_2014_P2_Q11 = {
  // ============================================================================
  // SECTION 1 — IDENTITY / SOURCE
  // ============================================================================
  identity: { id: "N5_MATH_2014_P2_Q11", schemaVersion: "N5_CATALOG_V2", courseId: "N5_MATH", paperContextId: "N5_MATH_2014_P2_CONTEXT", year: 2014, paper: "P2", questionNumber: "11", answerCatalogId: "N5_MATH_2014_P2_Q11_MS" },
  ...
  "sourceMeasurements": [
    {
      ...
      "heightMm": 96.94,
      "widthMm": null,
      "boundaryConvention": "Bottom of the Q11 formula/instruction block to the top of Q12.",
      "notes": null
    }
  ],
  "notes": "Large upper-page working space is supplied before Q12."
  ...
  structure: { structureType: "SINGLE", totalMarks: 3, parts: [
  {
    ...
    "label": "",
    "marks": 3,
    "primarySkillId": "alg-a09-change-subject",
    "secondarySkillIds": [],
    "conceptIds": [
      "alg-a9-1"
    ],
    ...
    "calculatorBurden": "MENTAL_FRIENDLY"
  }
  ...
  // ============================================================================
  mathematics: {
  "primaryGoal": "Rearrange a multi-term formula to isolate a variable that is multiplied by a squared parameter and a fractional coefficient.",
  "subgoals": [
    {
      "id": "Q11_S1",
      "summary": "Subtract the ut term from both sides.",
      "dependsOnSubgoalIds": []
    },
    {
      "id": "Q11_S2",
      "summary": "Remove the factor one-half and divide by t squared to isolate a.",
      "dependsOnSubgoalIds": [
        "Q11_S1"
      ]
    }
  ...
  information: [
  {
    ...
    "normalisedContent": "formula has structure s=ut+(1/2)at^2",
    "value": "s=ut+0.5at^2",
    "unit": null,
    "source": "TEXT",
  ...
  },
  {
    ...
    "normalisedContent": "a is to become the subject",
    "value": null,
    "unit": null,
    "source": "TEXT",
    "explicitness": "EXPLICIT",
  ...
  "difficulty": {
    ...
    "dependencyCount": 0,
    "difficultyDrivers": [
      "isolating a term inside a sum",
      "handling fractional coefficient and squared variable"
    ]
  }
},
  numbers: {
  ...
  "burden": "MENTAL_FRIENDLY",
  "requiredFunctions": [],
  "modeSensitive": false,
  "modeRequirements": [],
  "notes": "The formula rearrangement is symbolic and calculator-independent."
},
  parameterDesign: {
  ...
  "parameterConstraints": [
    "target variable appears linearly in one term",
    "other symbols remain non-zero where division is required"
  ],
  "safeVariationAxes": [
    "symbol names",
    "integer/fractional coefficient",
    "power on non-target factor"
  ],
  "invariantRelationships": [
    "target variable isolated by inverse operations"
  ],
  "degeneracyConditionsToAvoid": [
    "target variable appears in multiple terms",
    "division by a symbol that can be zero without domain qualification"
  ]
},
  constraints: {
  "mathematicalDomainConstraints": [
    "t must be non-zero in the rearranged form because division by t^2 is required."
  ],
  ...
  "promptSummary": "Rearrange a supplied formula containing a sum and a half-times-squared term so that a specified variable is the subject.",
  "styleNotes": null,
  "promptStructure": {
    "sentenceCount": 1,
    "promptWordCount": 14,
    "introductionStyle": "SUPPLIED_FORMULA_FOLLOWED_BY_TARGET_VARIABLE",
    "relationshipStatementStyle": null,
    "commandStyle": "CHANGE_SUBJECT_COMMAND",
    "temporalStructure": "NONE",
    "informationOrder": [
      "FORMULA",
      "TARGET_SUBJECT_VARIABLE"
    ],
    "normalisedPromptStructure": [
      "Supply a formula containing the target variable in a multiplicative term.",
      "Ask to make that variable the subject."
    ],
    ...
    "generatorVariationNotes": "Vary coefficients, symbols and powers while preserving several inverse operations and a unique valid rearrangement."
  }
},
  ...
  "rationalExpressionPresent": false,
  "changeOfSubjectRequired": true
  ...
  // ============================================================================
  family: {
  "familyId": "ALG_CHANGE_SUBJECT_LINEAR_TARGET_WITH_POWERED_FACTOR",
  "subFamilyId": null,
  "familyConfidence": "HIGH",
  "structuralSignature": [
    "target variable in one additive term",
    "fractional coefficient",
    "powered non-target factor"
  ],
  "surfaceStyleIds": [
    "INLINE_FORMULA_REARRANGEMENT"
  ],
  "relatedFamilyIds": []
},
  surface: {
  ...
  "linkedGeneratorFamilyIds": [
    "ALG_CHANGE_SUBJECT_LINEAR_TARGET_WITH_POWERED_FACTOR"
  ],
  "invariantMathematics": [
    "target appears linearly once",
    "inverse operations isolate target"
  ],
  "variableParameters": [
    "symbol names",
    "coefficient",
    "power/factor structure"
  ],
  "parameterConstraints": [
    "algebraic division remains valid under stated assumptions"
  ],
  "safeContextVariations": [],
  "safeRepresentationVariations": [],
  "unsafeVariations": [],
  "difficultyControls": [
    "number of inverse-operation stages",
    "fractional coefficient complexity"
  ],
