...
/**
 * The historical best-fit wrapper contains a fourth mark owned by S2. Until
 * that generation layer is deliberately implemented, G1 emits only the
 * three-mark model-construction part and records the omitted composite mark.
 */
