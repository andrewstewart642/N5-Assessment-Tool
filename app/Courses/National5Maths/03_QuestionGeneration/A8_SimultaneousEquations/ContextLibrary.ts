...
export const A8_CONTEXT_SHELLS: A8ContextShell[] = [
  ...
  purchase("SMOOTHIE_FRUIT_CUP", ["smoothie", "fruit cup"], ["smoothies", "fruit cups"], "at a juice bar", "at the same juice bar", range(2.5, 5.5, 0.25), range(1.8, 4, 0.25)),
  ...
  purchase("GIFT_BAG_CARD", ["gift bag", "greetings card"], ["gift bags", "greetings cards"], "at a gift shop", "at the same gift shop", range(1.5, 4.5, 0.25), range(1, 3.5, 0.25)),
  ...
  resource("SPORTS_BIB_TEAM_FLAG_FABRIC", ["sports bib", "team flag"], ["sports bibs", "team flags"], "is making fabric items for a sports club", "makes", "fabric", "area", "m²", "square metres", range(0.4, 1.2, 0.1), range(0.6, 1.6, 0.1)),
