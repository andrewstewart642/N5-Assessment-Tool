 ...
 *
 * Trusted migrated skills route through clean preservation bridges. Skills
 * which have not yet had a migration/rebuild decision continue to use their
 * existing Legacy implementation explicitly. This keeps the handover
 * architectural rather than silently rewriting working generators.
 */
