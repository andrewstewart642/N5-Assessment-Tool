...
export type ExamMarkingSchemeId =
  string;


export type ExamMarkingSchemeSourceContext =
  | "STANDARD_EXAM"
  | "COVID_RESOURCE";


export type ExamMarkingSchemeReviewStatus =
  | "DRAFT"
  | "CATALOGUED"
  | "REVIEWED"
  | "APPROVED";
...
export type ExamMarkingSchemeMethodEvidence = {
  /**
...
export type ExamMarkingSchemeMarkEvidence = {
  markNumber:
    number;
...
export type ExamMarkingSchemeExpectedAnswer = {
  /**
...
export type ExamMarkingSchemeRule = {
  /**
...
export type ExamMarkingSchemeCommonResponse = {
  id:
    string;
...
export type ExamMarkingSchemeMeasurementMethod =
  | "PDF_RENDER"
  | "MANUAL_ESTIMATE"
  | "NOT_MEASURED";


export type ExamMarkingSchemePdfRenderMeasurement = {
  /**
...
export type ExamMarkingSchemePdfMeasuredBlock = {
  measurementMethod:
    "PDF_RENDER";

  sourceMeasurement:
    ExamMarkingSchemePdfRenderMeasurement;
...
export type ExamMarkingSchemeEstimatedBlock = {
  measurementMethod:
    | "MANUAL_ESTIMATE"
    | "NOT_MEASURED";
...
export type ExamMarkingSchemeMeasuredBlock =
  | ExamMarkingSchemePdfMeasuredBlock
  | ExamMarkingSchemeEstimatedBlock;


export type ExamMarkingSchemeLayoutEvidence = {
  /**
   ...
   */
  coreEvidenceBlock?:
    ExamMarkingSchemeMeasuredBlock;
...
export type ExamMarkingSchemeCatalogEntry = {
  id:
    ExamMarkingSchemeId;
   ...
   */
  sourceContext:
    ExamMarkingSchemeSourceContext;
   ...
   */
  expectedAnswer?:
    ExamMarkingSchemeExpectedAnswer;
   ...
   */
  commonResponses?:
    ExamMarkingSchemeCommonResponse[];
   ...
   */
  sourceLayout?:
    ExamMarkingSchemeLayoutEvidence;


  reviewStatus:
    ExamMarkingSchemeReviewStatus;
};