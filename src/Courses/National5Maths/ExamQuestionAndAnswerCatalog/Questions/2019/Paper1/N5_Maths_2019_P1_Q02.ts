...
export const N5_MATHS_2019_P1_Q02 = {
  ...
  numberProfile: {
    ...
    notes:
      "Values are selected so multiplication after mixed-number conversion remains manageable and the final answer simplifies neatly, often with a visible cancellation route.",
  },
  ...
  styleNotes:
    "Presented as a compact inline calculation after a short Evaluate command, followed by a separate simplest-form instruction. This matches the broad surface style used by the 2025, 2023 and 2014 fraction entries, but with the proper fraction appearing before the mixed number.",
